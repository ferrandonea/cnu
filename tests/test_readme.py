...
def test_ejemplos_actuales_tm2020():
    ...
    assert cnu.cnu_afiliado(65, agno_actual=2026) == 14.042741
    ...
    assert cnu.faj_afiliado(65, rp=0.03, agno_actual=2026) == pytest.approx(0.037205, abs=1e-6)
    assert cnu.faj_afiliado(65, 62, rp=0.03, agno_actual=2026) == pytest.approx(0.004659, abs=1e-6)
    ...
    assert cnu.describir("soltero sin hijos", "vigente", agno_actual=2026) == (
...
def test_ejemplos_historicos():
    ...
    assert cnu.faj_afiliado(65, 62, rp=0.03, agno_actual=2014) == pytest.approx(0.013094, abs=1e-6)
...
def test_vectorial_por_fsiniestro():
    v = cnu.cnu_afiliado_vec([55, 65, 75], fsiniestro=[20130101, 20200101, 20240101], agno_actual=2026)
    esperado = [
        cnu.cnu_afiliado(55, tabla="rv2009", agno_actual=2026),
        cnu.cnu_afiliado(65, tabla="cb2014", agno_actual=2026),
        cnu.cnu_afiliado(75, tabla="cb2020", agno_actual=2026),
    ]
